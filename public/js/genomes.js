...
function adv_toggle_cb_categories(x){
    if(x == 'off'){
        ...
        document.getElementById("adv_mag").checked = false;
        
        var link_html = "<a class=\"pill pill-aqua\" href='#' onclick=\"adv_toggle_cb_categories('on')\">Toggle CheckBoxes On/Off</a>"
        document.getElementById('adv_toggle_cb_categories_span').innerHTML = link_html
    }else{
        ...
        document.getElementById("adv_mag").checked = true;
        var link_html = "<a class=\"pill pill-aqua\" href='#' onclick=\"adv_toggle_cb_categories('off')\">Toggle CheckBoxes On/Off</a>"
        document.getElementById('adv_toggle_cb_categories_span').innerHTML = link_html
    }
    adv_update_sb()
}
