...
function get_contig_seq(gid, mid, type) {
  ...
  var win = window.open(
    "Contig Sequence",
    null,
    "menubar=no,status=no,toolbar=no,location=no,width=900,height=300,scrollbars=yes",
  );
  ...
  xmlhttp.onreadystatechange = function () {
    if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
      ...
      doc.write(
        "<title>eHOMD Contig Sequence</title><body><div style='overflow:auto; height:100%;'>" +
          text +
          "</div></body>",
      );
      doc.close();
...
//
function get_AA_NA_seq(type, pid, db, mol, org, product, gid) {
  // type=nn or na
  ...
  xmlhttp.open("POST", "/genome/get_AA_NA_seq", true);
  xmlhttp.setRequestHeader("Content-type", "application/json");
  xmlhttp.onreadystatechange = function () {
    if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
      const resp = JSON.parse(xmlhttp.responseText);
      ...
      doc.write(
        "<title>eHOMD 16s rRNA Gene Sequence</title><body><div style='overflow:auto; height:100%;'>" +
          text +
          "</div></body>",
      );
      doc.close();
...
function toggle_cb_levels(x) {
  if (x == "off") {
    ...
    var link_html =
      "<a class=\"pill pill-aqua\" href='#' onclick=\"toggle_cb_levels('on')\">Toggle On/Off</a>";
    ...
    var link_html =
      "<a class=\"pill pill-aqua\" href='#' onclick=\"toggle_cb_levels('off')\">Toggle On/Off</a>";
    document.getElementById("toggle_cb_levels_span").innerHTML = link_html;
  }
  update_sb();
}
function adv_toggle_cb_levels(x) {
  if (x == "off") {
    ...
    var link_html =
      "<a class=\"pill pill-aqua\" href='#' onclick=\"adv_toggle_cb_levels('on')\">Toggle On/Off</a>";
    ...
    var link_html =
      "<a class=\"pill pill-aqua\" href='#' onclick=\"adv_toggle_cb_levels('off')\">Toggle On/Off</a>";
    document.getElementById("adv_toggle_cb_levels_span").innerHTML = link_html;
  }
  adv_update_sb();
}
function adv_toggle_cb_sites(x) {
  if (x == "off") {
    ...
    document.getElementById("adv_environmental").checked = false;

    document.getElementById("adv_unassigned").checked = false;
    var link_html =
      "<a class=\"pill pill-btn\" href='#' onclick=\"adv_toggle_cb_sites('on')\">Toggle On/Off</a>";
    ...
    document.getElementById("adv_environmental").checked = true;

    document.getElementById("adv_unassigned").checked = true;
    var link_html =
      "<a class=\"pill pill-btn\" href='#' onclick=\"adv_toggle_cb_sites('off')\">Toggle On/Off</a>";
    document.getElementById("adv_toggle_cb_sites_span").innerHTML = link_html;
  }
  adv_update_sb();
}
function adv_toggle_cb_abund(x) {
  ...
  if (x == "off") {
    ...
    var link_html =
      "<a class=\"pill pill-btn\" href='#' onclick=\"adv_toggle_cb_abund('on')\">Toggle On/Off</a>";
    ...
    var link_html =
      "<a class=\"pill pill-btn\" href='#' onclick=\"adv_toggle_cb_abund('off')\">Toggle On/Off</a>";
    document.getElementById("adv_toggle_cb_abund_span").innerHTML = link_html;
  }
  adv_update_sb();
}
function adv_toggle_cb_status(x) {
  ...
  if (x == "off") {
    ...
    var link_html =
      "<a class=\"pill pill-btn\" href='#' onclick=\"adv_toggle_cb_status('on')\">Toggle On/Off</a>";
    ...
    var link_html =
      "<a class=\"pill pill-btn\" href='#' onclick=\"adv_toggle_cb_status('off')\">Toggle On/Off</a>";
    document.getElementById("adv_toggle_cb_status_span").innerHTML = link_html;
  }
  adv_update_sb();
}
