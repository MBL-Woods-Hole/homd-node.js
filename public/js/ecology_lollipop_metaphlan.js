...
if(rank == 'species'){
       ...
       data_ary = hmpmetaphlan.filter( (x) => { return x.avg > 0})
       ND_ary   = hmpmetaphlan.filter( (x) => { return x.avg == 0})
       data = data_ary
       //console.log(ND_ary)
    ...
    var mouseover = function(e,d){ 
        ...
        var plotValue = d.avg;
        var prev = d.prev;
        tooltips.hmpmetaphlan_log.html(plotName+"<br>"+"Lineage: "+lineage+"<br>"+"Site: <span style='border:1px solid black;padding:1px 8px;background:"+site_colors3[d.site]+";'></span>&nbsp;&nbsp;" + siteName + "<br>" + "Abundance: " + plotValue+" % "+ "<br>" + "Prevalence: " + prev+" %")
         //console.log(e.x,e.y)
