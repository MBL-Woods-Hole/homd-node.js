{
    "domain":{
       "Bacteria":{
            "filename1":"C.images_loc['bac1'].fname",
			"text1":"C.images_loc['bac1'].caption",
			"filename2":"C.images_loc['bac2'].fname",
			"text2":"C.images_loc['bac2'].caption",
			"filename3":"C.images_loc['bac3'].fname",
			"text3":"C.images_loc['bac3'].caption"
        },
       "Archaea":{
    ...
    "genus":{
       "Actinomyces":
        ...
        {
        "all_species":false,
        "filename1":"C.images_loc['I-7'].fname",
        "text1":"C.images_loc['I-7'].caption"
    ...
    "species": {
       ...
       "545":
        ...
        "filename2":"C.images_loc['I-11'].fname",
        "text2":"C.images_loc['I-11'].caption"
        },
        "953":
        {
        ...
        "text1":"C.images_loc['I-3'].caption"
         ...
         "420":
        {
        "species":"Fusobacterium nucleatum subsp._animalis",
        "filename1":"C.images_loc['I-3'].fname",
        "text1":"C.images_loc['I-3'].caption"
         },
         "698":
        {
        "species":"Fusobacterium nucleatum subsp._nucleatum",
        "filename1":"C.images_loc['I-3'].fname",
        "text1":"C.images_loc['I-3'].caption"
         },
         "202":
        {
        "species":"Fusobacterium nucleatum subsp._polymorphum",
        "filename1":"C.images_loc['I-3'].fname",
        "text1":"C.images_loc['I-3'].caption"
         },
         "200":
        {
        "species":"Fusobacterium nucleatum subsp._vincentii ",
        "filename1":"C.images_loc['I-3'].fname",
        "text1":"C.images_loc['I-3'].caption"
         },
        "203":
        ...
        "filename1":"C.images_loc['I-4'].fname",
        "text1":"C.images_loc['I-4'].caption"
         },
         "945":
        {
       ...
       "filename1":"C.images_loc['I-7'].fname",
        ...
        "578":
        {
        "species":"Streptococcus cristatus clad_578",
        "filename1":"C.images_loc['I-1'].fname",
        "text1":"C.images_loc['I-1'].caption"
         },
        "886":
        {
        "species":"Streptococcus cristatus clade_886",
        "filename1":"C.images_loc['I-1'].fname",
        "text1":"C.images_loc['I-1'].caption"
         },
        ...
        "431":
        {
        "species":"Streptococcus infantis clade_431",
        "filename1":"C.images_loc['I-7'].fname",
        "text1":"C.images_loc['I-7'].caption"
         },
        "638":
        {
        "species":"Streptococcus infantis clade_638",
        "filename1":"C.images_loc['I-7'].fname",
        "text1":"C.images_loc['I-7'].caption"
         },
        "677":
        ...
        "58":
        {
        "species":"Streptococcus oralis subsp._dentisani_clade_058",
        "filename1":"C.images_loc['I-1'].fname",
        "text1":"C.images_loc['I-1'].caption"
         },
         "398":
        {
        "species":"Streptococcus oralis subsp._dentisani_clade_398",
        "filename1":"C.images_loc['I-1'].fname",
        "text1":"C.images_loc['I-1'].caption"
         },
         "707":
        {
        "species":"Streptococcus oralis subsp._oralis",
        "filename1":"C.images_loc['I-1'].fname",
        "text1":"C.images_loc['I-1'].caption"
         },
         "70":
        {
        "species":"Streptococcus oralis subsp._tigurinus_clade_070",
        "filename1":"C.images_loc['I-1'].fname",
        "text1":"C.images_loc['I-1'].caption"
         },
         "71":
        {
        "species":"Streptococcus oralis subsp._tigurinus_clade_071",
        "filename1":"C.images_loc['I-1'].fname",
        "text1":"C.images_loc['I-1'].caption"
         },
