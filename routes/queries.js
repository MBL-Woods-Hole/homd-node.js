...
module.exports.get_all_genomes = (gid) => {
...
module.exports.get_genome = (gid) => {   // always NCBI for taxon description
  ...
  let qSelectGenome = "SELECT `genomesV11.0`.strain,`genomes_prokkaV11.0`.organism,`genomesV11.0`.contigs,`genomesV11.0`.combined_size,`genomesV11.0`.category,`genomesV11.0`.GC,`genomesV11.0`.url, "
