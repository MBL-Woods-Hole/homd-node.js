...
router.post("/phage_ajax", async function phage_ajax(req, res) {
  ...
  let html_rows =
    ...
    ")";
  html_rows +=
    "<a href='#' onclick=close_sub_table() style='float:right;margin-right:100px;' border='1'>Close</a>";
  html_rows += "<table id='XXphage-sub-table' class='table result-table '>";
  html_rows += "<tr>";
  html_rows +=
    "<th>Prediction<br>Tool</th><th>Genome<br>Viewer</th><th class=''>Phage-ID</th><th>Contig</th><th>Start</th><th>End</th>";
  html_rows += "</tr>";
